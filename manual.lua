...
Pages={
    ...
    },
    {
        bg=3,
        title="bombs",
        text=prepare_text("tHESE CAN BE A GREAT TOOL~TO CLEAR DEBRIS FOUND BELOW~AND UNCOVER HIDDEN SECRETS.~tHEIR EXPLOSION CAN BE~QUITE DEADLY TOO! jUST MAKE~SURE TO BACK AWAY QUICKLY~BEFORE A BOMB GOES OFF. aND~BE CAREFUL, BECAUSE BOMBS~WILL GO OFF IMMEDIATELY~WHEN THEY COME IN CONTACT~WITH A DANGEROUS CREATURE."),
        image={
            f=40,
            w=0.875,
            h=0.875,
